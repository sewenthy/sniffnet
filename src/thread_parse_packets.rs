...
fn bar(info_traffic_mutex: &Arc<Mutex<InfoTraffic>>, mut exchanged_bytes: u128, mut application_protocol: AppProtocol, mut traffic_type: TrafficType, country_db_reader: &Reader<&[u8]>, key: &AddressPortPair) {
