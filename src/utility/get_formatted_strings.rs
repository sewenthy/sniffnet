...
#[doc = " Application version number (to be displayed in gui footer)"]
pub const APP_VERSION: &str = env!("CARGO_PKG_VERSION");
#[doc = " Computes the String representing the percentage of filtered bytes/packets"]
...
#[doc = " Computes the String representing the active filters"]
...
#[doc = " Computes the String representing the active filters, without line breaks"]
...
#[doc = " Returns the color to be used for a specific connection of the relevant connections table in gui run page"]
...
#[doc = " Given the map of app layer protocols with the relative sniffed packets count,"]
#[doc = " the function generates the corresponding String"]
#[doc = " to be displayed in gui run page."]
#[doc = ""]
#[doc = " # Arguments"]
#[doc = ""]
#[doc = " * `app_count` - Map of app layer protocols with the relative sniffed packets count"]
#[doc = ""]
#[doc = " * `tot_packets` - Total number of sniffed packets"]
pub fn get_app_count_string(app_count: &HashMap<AppProtocol, u128>, tot_packets: u128) -> String {
    ...
    let mut longest_num = bar(app_count, &sorted_app_count);
...
fn bar(
    ...
    sorted_app_count: &Vec<(&AppProtocol, &u128)>,
) -> usize {
...
#[doc = " Returns a String representing a quantity of bytes with their proper multiple (KB, MB, GB, TB)"]
